...
class NewIncubatorWebPage extends StatelessWidget {
  static const routeName = '/newincubatorwebpage';
        ...
        builder: (BuildContext context, Widget childWidget,
          ...
          return Scaffold(
              appBar: AppBar(
                ...
                title: Text('New Incubator Web Page',style: TextStyle(color: Colors.white)),
                centerTitle: true,
              ),
