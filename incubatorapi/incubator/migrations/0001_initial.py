# Generated by Django 3.0.5 on 2020-08-24 18:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateOfBirth', models.DateTimeField()),
                ('createdDate', models.DateTimeField()),
                ('userId', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='frontdeskdetial', serialize=False, to='incubator.User')),
            ],
        ),
        migrations.CreateModel(
            name='Nurse',
