    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('createdDate', models.DateTimeField(auto_now=True)),
                ('nurseId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nurseshift', to='incubator.Doctor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.FloatField()),
                ('billId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bill', to='incubator.Bill')),
            ],
        ),
        migrations.AddField(
            model_name='bill',
